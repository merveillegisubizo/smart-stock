                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <Link to="/" className="flex items-center space-x-2">
                            <div>
                                ...
                                <p className="text-xs text-green-200">SmartPark Inventory</p>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <button
                            ...
                            className="bg-green-700 hover:bg-green-600 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200"
                        >
                            Logout
                        </button>
                    </div>
