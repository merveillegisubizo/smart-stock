        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-4 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="card bg-gradient-to-r from-green-600 to-green-700 text-white">
                    <div>
                        <p className="text-green-100">Total Parts</p>
                ...
                <div className="card bg-gradient-to-r from-green-700 to-green-800 text-white">
                    <div>
                        <p className="text-green-100">Total Quantity</p>
                        <p className="text-2xl font-bold">{formatNumber(stockStatus?.summary?.totalCurrentQuantity || 0)}</p>
                    </div>
                </div>

                <div className="card bg-gradient-to-r from-green-800 to-green-900 text-white">
                    <div>
                ...
                <div className="card bg-gradient-to-r from-green-900 to-gray-900 text-white">
                    <div>
                        <p className="text-green-100">Low Stock</p>
            ...
            <div className="flex flex-col space-y-6">
                ...
                <div className="card">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <Link to="/stock-out" className="text-green-700 hover:text-green-800 text-sm">
                            View All
                        </Link>
                    </div>
